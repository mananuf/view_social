use crate::domain::entities::{User, Post, Message, MessageRead, Wallet, Transaction};
...
pub trait PostRepository: Send + Sync {
    ...
    /// Get reels only
    async fn find_reels(&self, user_id: Option<Uuid>, limit: i64, offset: i64) -> Result<Vec<Post>>;
...
pub trait MessageRepository: Send + Sync {
    ...
    async fn search_in_conversation(&self, conversation_id: Uuid, query: &str, limit: i64, offset: i64) -> Result<Vec<Message>>;
    ...
    async fn find_by_type(&self, conversation_id: Uuid, message_type: &str, limit: i64, offset: i64) -> Result<Vec<Message>>;
}
...
pub trait WalletRepository: Send + Sync {
    ...
    async fn get_transaction_history(&self, wallet_id: Uuid, limit: i64, offset: i64) -> Result<Vec<Transaction>>;
    ...
    async fn process_transfer(&self, sender_wallet_id: Uuid, receiver_wallet_id: Uuid, amount: Decimal, transaction: &Transaction) -> Result<Transaction>;
}